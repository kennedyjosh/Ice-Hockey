...
## A Button can be clicked, and when clicked it will trigger an event
class Button:
    ## Initialize 
...
class Label:
    ...
    def __init__(self,locationTuple,width, height, text, customFont = None):
        ...
        self.width, self.height = width, height
        self.textString, self.textColor = text, (255,255,255)
        self.textPos, self.textSize = "R", 90
    ...
    def setTextSize(self):
        ...
        while self.textFont.size(self.textString)[0] > w and self.textFont.size(self.textString)[1] < h and self.textSize > 45:
            self.textSize -= 1
